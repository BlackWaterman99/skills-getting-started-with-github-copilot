...
activities = {
    ...
    "Basketball Club": {
        "description": "Pick-up games and skill drills for all levels",
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and preparing school productions",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["sophia.p@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Club": {
